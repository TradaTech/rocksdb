...
# , 'OTHER_LDFLAGS': ['-stdlib=libc++']
  ...
  , 'sources': [
      ...
      , 'leveldb-<(ldbversion)/db/compaction_picker_fifo.cc'
      , 'leveldb-<(ldbversion)/db/compaction_picker_universal.cc'
      ...
      , 'leveldb-<(ldbversion)/db/db_impl_write.cc'
      , 'leveldb-<(ldbversion)/db/db_impl_compaction_flush.cc'
      , 'leveldb-<(ldbversion)/db/db_impl_files.cc'
      , 'leveldb-<(ldbversion)/db/db_impl_open.cc'
      , 'leveldb-<(ldbversion)/db/db_impl_debug.cc'
      , 'leveldb-<(ldbversion)/db/db_impl_readonly.cc'
      , 'leveldb-<(ldbversion)/db/db_impl_secondary.cc'
      ...
      , 'leveldb-<(ldbversion)/db/in_memory_stats_history.cc'
      ...
      , 'leveldb-<(ldbversion)/options/options_sanity_check.cc'
      ...
      , 'leveldb-<(ldbversion)/table/data_block_hash_index.cc'
      , 'leveldb-<(ldbversion)/table/data_block_footer.cc'
      ...
      , 'leveldb-<(ldbversion)/util/filename.cc'
      , 'leveldb-<(ldbversion)/util/filter_policy.cc'
      , 'leveldb-<(ldbversion)/util/hash.cc'
      , 'leveldb-<(ldbversion)/util/jemalloc_nodump_allocator.cc'
      ...
      , 'leveldb-<(ldbversion)/util/sync_point_impl.cc'
      , 'leveldb-<(ldbversion)/util/thread_local.cc'
      , 'leveldb-<(ldbversion)/util/threadpool_imp.cc'
      , 'leveldb-<(ldbversion)/util/trace_replay.cc'
      ...
      , 'leveldb-<(ldbversion)/utilities/blob_db/blob_log_format.cc'
      , 'leveldb-<(ldbversion)/utilities/blob_db/blob_log_reader.cc'
      , 'leveldb-<(ldbversion)/utilities/blob_db/blob_log_writer.cc'
      , 'leveldb-<(ldbversion)/utilities/cassandra/cassandra_compaction_filter.cc'
      , 'leveldb-<(ldbversion)/utilities/cassandra/cassandra_format.cc'
      , 'leveldb-<(ldbversion)/utilities/cassandra/cassandra_merge_operator.cc'
